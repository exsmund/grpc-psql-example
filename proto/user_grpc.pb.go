...
type UserRepoClient interface {
	SaveUser(ctx context.Context, in *User, opts ...grpc.CallOption) (*SaveUserResponse, error)
	DeleteUser(ctx context.Context, in *UserUUID, opts ...grpc.CallOption) (*DeleteUserResponse, error)
...
func (c *userRepoClient) SaveUser(ctx context.Context, in *User, opts ...grpc.CallOption) (*SaveUserResponse, error) {
	out := new(SaveUserResponse)
	err := c.cc.Invoke(ctx, "/grpc_psql_example.user.UserRepo/SaveUser", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *userRepoClient) DeleteUser(ctx context.Context, in *UserUUID, opts ...grpc.CallOption) (*DeleteUserResponse, error) {
	out := new(DeleteUserResponse)
	err := c.cc.Invoke(ctx, "/grpc_psql_example.user.UserRepo/DeleteUser", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *userRepoClient) GetUsers(ctx context.Context, in *GetUsersRequest, opts ...grpc.CallOption) (UserRepo_GetUsersClient, error) {
	stream, err := c.cc.NewStream(ctx, &UserRepo_ServiceDesc.Streams[0], "/grpc_psql_example.user.UserRepo/GetUsers", opts...)
	if err != nil {
		return nil, err
	}
...
type UserRepoServer interface {
	SaveUser(context.Context, *User) (*SaveUserResponse, error)
	DeleteUser(context.Context, *UserUUID) (*DeleteUserResponse, error)
...
func (UnimplementedUserRepoServer) SaveUser(context.Context, *User) (*SaveUserResponse, error) {
	return nil, status.Errorf(codes.Unimplemented, "method SaveUser not implemented")
}
func (UnimplementedUserRepoServer) DeleteUser(context.Context, *UserUUID) (*DeleteUserResponse, error) {
...
func _UserRepo_SaveUser_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/grpc_psql_example.user.UserRepo/SaveUser",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(UserRepoServer).SaveUser(ctx, req.(*User))
	}
...
func _UserRepo_DeleteUser_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/grpc_psql_example.user.UserRepo/DeleteUser",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(UserRepoServer).DeleteUser(ctx, req.(*UserUUID))
	}
	return interceptor(ctx, in, info, handler)
}
...
var UserRepo_ServiceDesc = grpc.ServiceDesc{
	ServiceName: "grpc_psql_example.user.UserRepo",
